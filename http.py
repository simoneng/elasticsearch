...
def serve(host='0.0.0.0', port=5656, verbosity=1):
    try:
        ...
        sensorLoc_dict = {'1': 'Building A', '2': 'Building D', '3': 'Building E'}
        sensorIP_dict = {'1': '203.117.65.203', '2': '203.117.65.204', '3': '203.217.186.4'}
